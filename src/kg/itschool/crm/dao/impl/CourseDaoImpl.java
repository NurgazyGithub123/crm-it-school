...
public class CourseDaoImpl implements CourseDao {
    ...
    public Course save(Course course) {
        ...
        try {
            ...
            String readQuery = "SELECT * FROM tb_courses c " +
                    "JOIN tb_course_format f " +
            ...
            courseFormat.setLessonPerWeek(resultSet.getInt("lesson_peer_week"));
    ...
    public Course findById(Long id) {
        ...
        try {
            ...
            CourseFormat savedCourseFormat = new CourseFormat();
            ...
            savedCourseFormat.setLessonPerWeek(resultSet.getInt("lesson_peer_week"));
            ...
            course.setCourseFormat(savedCourseFormat);
